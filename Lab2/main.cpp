...
void lalbagFort()
{
    ...
    glBegin(GL_QUADS);
	glColor3ub(156, 159, 161);
	glVertex2f(-0.07f, 0.075f);
	glVertex2f(0.07f, 0.075f);
	glVertex2f(0.07f, 0.0825f);
	glVertex2f(-0.07f, 0.0825f);
	glEnd();
...
void moveBus()
{
    ...
    glBegin(GL_QUADS);
    glColor3f(1.0f,1.0f,1.0f);
    glVertex2f(-0.617f, -0.9f);
    glVertex2f(-0.623f, -0.9f);
    glVertex2f(-0.623f, -0.86f);
    glVertex2f(-0.617f, -0.86f);
    glEnd();
    ...
    glVertex2f(-0.875f, -0.78f);
    glVertex2f(-0.945f, -0.78f);
    glVertex2f(-0.96f, -0.82f);
    glEnd();
    ...
    glColor3ub(84, 84, 84);
	circle(-0.69f,-0.94f,0.036f);
	circle(-0.92f,-0.94f,0.036f);

    glColor3ub(0, 0, 0);
	circle(-0.69f,-0.94f,0.033f);
	circle(-0.92f,-0.94f,0.033f);

	glColor3ub(37, 35, 36);
	circle(-0.69f,-0.94f,0.025f);
	circle(-0.92f,-0.94f,0.025f);
...
void bird()
{
    ...
    glColor3ub(252, 248, 124);
    circle(-0.95, 0.7, 0.025);
    ...
    glBegin(GL_TRIANGLES);
    glColor3ub(216, 0, 38);
    glVertex2f(-0.926f,0.69f);
    glVertex2f(-0.912f,0.7f);
    glVertex2f(-0.926f,0.71f);
    glEnd();
    ...
    if(w%2 == 0)
    {
        glBegin(GL_TRIANGLES);
        glColor3ub(216, 0, 38);
        glVertex2f(-0.943f,0.78f);
        glVertex2f(-0.957f,0.78f);
    ...
    else
    {
        glBegin(GL_TRIANGLES);
        glColor3ub(216, 0, 38);
        glVertex2f(-0.943f,0.62f);
        glVertex2f(-0.957f,0.62f);
        glVertex2f(-0.95f,0.7f);
        glEnd();
    }
    ...
    glColor3ub(204, 255, 238);
    circle(-0.85, 0.7, 0.025);
    ...
    glBegin(GL_TRIANGLES);
    glColor3ub(4, 116, 59);
    glVertex2f(-0.826f,0.69f);
    glVertex2f(-0.812f,0.7f);
    glVertex2f(-0.826f,0.71f);
    glEnd();
    ...
    if(w%2 ==0)
    {
        glBegin(GL_TRIANGLES);
        glColor3ub(4, 116, 59);
        glVertex2f(-0.843f,0.78f);
        glVertex2f(-0.857f,0.78f);
    ...
    else
    {
        glBegin(GL_TRIANGLES);
        glColor3ub(4, 116, 59);
        glVertex2f(-0.843f,0.62f);
        glVertex2f(-0.857f,0.62f);
        glVertex2f(-0.85f,0.7f);
        glEnd();
    }
